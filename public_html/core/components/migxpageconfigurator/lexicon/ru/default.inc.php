...
$_lang['setting_mpc_exclude_lexicons_fields'] = 'Список полей, которые не нужно переводить';
$_lang['setting_mpc_exclude_lexicons_fields_desc'] = 'перечислять ключи полей через запятую без пробелов';
