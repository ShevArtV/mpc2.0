...
$_lang['setting_mpc_contacts_tv_id'] = 'Имя TV для контактов';
...
$_lang['setting_mpc_service_info_tv_id'] = 'ID TV со служебной информацией';
$_lang['setting_mpc_service_info_tv_id_desc'] = 'значение по умолчанию задается при установке';
