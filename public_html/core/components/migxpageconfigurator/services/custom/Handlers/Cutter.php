...
class Cutter extends Base
{
    ...
    protected function initialize(): void
    {
        ...
        $properties = [
            ...
            'chunkNames'        => [],
            'pattern'           => '/(\s)*?data-mpc(?:ve)?-(nolazy|copy|symbol|if|static|name|item|unwrap|section|snippet|chunk|include|parse|remove|attr|field|ftype|fcap|fdesc|cfield|rfield|res|tv|contact|ctx|info|lim|off|nothumb|thumb|lexicon|key)(-){0,1}([0-9]*)(=".*?"){0,1}(\s)*?/',
