...
$file_names = $argv[2];
$mpc->sliceTemplates($file_names);

// пример команды для консоли
// php -d display_errors -d error_reporting=E_ALL public_html/core/components/migxpageconfigurator/console/slice_tpl.php web wrapper.tpl